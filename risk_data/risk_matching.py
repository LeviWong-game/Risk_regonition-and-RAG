...
PATTERN_RULES: Dict[str, Dict[int, Tuple[str, ...]]] = {
    ...
    "persistence_recurrence": {
        2: ("再次", "又来", "反复", "重复", "多日", "多次"),
        3: ("多次反映", "持续", "长期", "一直", "多次投诉", "久拖未决", "无果", "催讨", "未支付", "停运已两周", "多次催促", "拖延"),
    ...
    "impact_scope": {
        ...
        4: ("社区", "村民", "整栋楼", "周边商户", "多人受影响", "电梯故障停运", "公共设施长期不可用"),
        5: ("跨区域", "大范围", "全小区", "全村", "全网关注"),
    },
    "safety_health_harm": {
        2: ("扰民", "异味", "噪音", "轻微受伤", "轻伤", "惊吓"),
        3: ("污染", "受伤", "骨折", "住院", "健康风险", "中毒风险", "苦不堪言"),
        4: ("工伤", "流血", "重大隐患", "火灾隐患", "人身伤害", "摔落", "排放超标", "影响居民健康", "居民健康"),
    ...
    "mediation_pressure": {
        ...
        4: ("多次催办", "调解失败", "久拖不决", "反复催办", "流程复杂", "拖延", "多次催促", "停运已两周", "出行不便"),
